...
# 🔥 PDF HANDLER (YOUR CODE CONNECTED)
from utils.pdf_handler import convert_pdf
...
def process():
    ...
    try:
        # 🔄 FILE CONVERSION (DOCX / PDF → EXCEL)
        ...
        if ext == ".docx":
            ...
            file_path = convert_pdf(module, file_path)
